    ...
    public partial class createUser : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                commandCheckToTruong.CommandText = "sp_create_user";
                ...
                commandCheckToTruong.Parameters.Add(new OracleParameter("pw", OracleDbType.Varchar2)).Value = txtpassword.Text.Trim();// pwd.Text.Trim();
                try
                {
                ...
                {
                    MessageBox.Show("Đã xảy ra lỗi khi thực hiện thêm user!");
                }
                con.Close();
            }
        }
